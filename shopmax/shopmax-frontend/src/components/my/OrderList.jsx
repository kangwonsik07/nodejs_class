...
function OrderList() {
   ...
   const [deleteComlete, setDeleteComlete] = useState(false) // 주문 삭제 토글

   useEffect(() => {
      dispatch(getOrdersThunk({ page, limit: 5, startDate: formattedStartDate, endDate: formattedEndDate }))
   }, [dispatch, page, formattedStartDate, formattedEndDate, cancelComplete, deleteComlete])
