...
module.exports = class Comment extends Sequelize.Model {
   static init(sequelize) {
      return super.init(
         ...
         },
         {
            ...
            tableName: 'comments', // 데이터 베이스에서 사용하는 실제 테이블 이름
   ...
   static associate(db) {
      // Comment는 User에 속해있다(User가 부모테이블, Comment가 자식테이블)
      db.Comment.belongsTo(db.User, {
         foreignKey: 'commenter', //Comment 외래키 칼럼 이름
         targetKey: 'id', //Comment가 User에서 참조할 칼럼이름
      })
   }
}
